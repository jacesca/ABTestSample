"""
Sample of how to do an A/B Test when variance are not equals.
"""
...
if p_value > 0.05:
    msg_temp = f'The {col} means of the two groups are NOT statistically different'  # noqa
else:
    ...
    msg_temp = f'The {col} means of the two groups are statistically different'
